...
----------------------------------------------------
-- BOTÃO VOAR (CRIA / DESTROI FLY GUI)
----------------------------------------------------
local voarBtn = Instance.new("TextButton")
voarBtn.Size = UDim2.fromOffset(360,50)
voarBtn.BackgroundColor3 = Color3.fromRGB(106,43,217)
voarBtn.Text = "VOAR : OFF"
voarBtn.Font = Enum.Font.FredokaOne
voarBtn.TextSize = 22
voarBtn.TextColor3 = Color3.new(1,1,1)
voarBtn.BorderSizePixel = 0
voarBtn.Parent = scroll
Instance.new("UICorner", voarBtn).CornerRadius = UDim.new(0,10)

local voarAtivo = false

local function criarFlyGui()

----------------------------------------------------
-- FLY GUI ORIGINAL (APENAS FONTES E CORES ALTERADAS)
----------------------------------------------------
...
mini2.Font = Enum.Font.FredokaOne
...
voarBtn.MouseButton1Click:Connect(function()
	...
	voarBtn.Text = voarAtivo and "VOAR : ON" or "VOAR : OFF"
